...
local function on_attach(client, bufnr)
    ...
    buf_set_keymap("n", "g?", "<cmd>lua require'lspsaga.signaturehelp'.signature_help()<CR>", opts)
    buf_set_keymap("n", "<space>rn", "<cmd>lua require'lspsaga.rename'.rename()<CR>", opts)
    buf_set_keymap("n", "gr", "<cmd>lua require'lspsaga.provider'.lsp_finder()<CR>", opts)
    buf_set_keymap("n", "<space>e", "<cmd>lua require'lspsaga.diagnostic'.show_cursor_diagnostics()<CR>", opts)
    ...
    elseif client.resolved_capabilities.document_range_formatting then
      buf_set_keymap("n", "<space>ca", "<cmd>lua require'lspsaga.codeaction'.range_code_action()<CR>", opts)
    end
