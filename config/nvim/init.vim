...
Plug 'Maxattax97/coc-ccls'                                            | "Clang補全
...
nnoremap <space>gT :bprevious<CR>
...
augroup two_space_indent
    au VimEnter,BufRead,BufNewFile *.cpp,*.h,*.cc set tabstop=2
    au VimEnter,BufRead,BufNewFile *.cpp,*.h,*.cc set shiftwidth=2
augroup END
