  ...
  return ((e) => {
    ...
    function f(e, t, r, o) {
        ...
        null != _.subLanguage
          ? (() => {
              ...
              if ("string" == typeof _.subLanguage) {
                ...
                (e = f(_.subLanguage, O, !0, k[_.subLanguage])),
                  (k[_.subLanguage] = e.top);
              } else e = p(O, _.subLanguage.length ? _.subLanguage : null);
              _.relevance > 0 && (A += e.relevance),
                M.addSublanguage(e.emitter, e.language);
            })()
          : (() => {
              if (!_.keywords) return void M.addText(O);
              let e = 0;
              _.keywordPatternRe.lastIndex = 0;
              let t = _.keywordPatternRe.exec(O),
                n = "";
              for (; t; ) {
      ...
      function h(e) {
        return (
          e.className &&
            M.openNode(w.classNameAliases[e.className] || e.className),
      ...
      function x(e) {
        ...
        r.skip
          ...
          : (r.returnEnd || r.excludeEnd || (O += t),
            ...
            r.excludeEnd && (O = t));
        do {
          _.className && M.closeNode(),
            _.skip || _.subLanguage || (A += _.relevance),
            (_ = _.parent);
        } while (_ !== s.parent);
        return (
          s.starts &&
      ...
      const w = N(e);
      if (!w)
        throw (C(l.replace("{}", e)), Error('Unknown language: "' + e + '"'));
      const R = I(w, { plugins: a });
      let y = "",
        _ = o || R;
      const k = {},
        M = new g.__emitter(g);
      ...
      try {
        for (_.matcher.considerAll(); ; ) {
          B++,
            T ? (T = !1) : _.matcher.considerAll(),
            (_.matcher.lastIndex = L);
          const e = _.matcher.exec(c);
          if (!e) break;
    ...
    function E(e) {
      ...
      if (d(n)) return;
      _("before:highlightBlock", { block: e, language: n }), (t = e);
      const s = t.textContent,
        a = n ? h(n, s, !0) : p(s);
      _("after:highlightBlock", { block: e, result: a, text: s }),
        (e.innerHTML = a.value),
        ((e, t, n) => {
          const s = t ? r[t] : n;
    ...
    const v = () => {
      v.called ||
        ((v.called = !0), document.querySelectorAll("pre code").forEach(E));
    };
    function N(e) {
    ...
    return (
      Object.assign(e, y), e.addPlugin(m), e.addPlugin(S), e.addPlugin(x), e
    );
  })({});
})();
...
hljs.registerLanguage(
  ...
  (() => {
    ...
    const t = (e) => i(/\b/, e, /\w$/.test(e) ? /\b/ : /\B/),
      u = ["Protocol", "Type"].map(t),
      s = ["init", "self"].map(t),
      r = ["Any", "Self"],
      o = [
        "associatedtype",
    ...
    return (e) => {
      const p = e.COMMENT("/\\*", "\\*/", { contains: ["self"] }),
        g = {
          className: "keyword",
          begin: i(/\./, n(a(...u, ...s))),
          end: a(...u, ...s),
        ...
        A = { begin: i(/\./, a(...o)), relevance: 0 },
        C = o.filter((e) => "string" == typeof e).concat(["_|0"]),
        v = {
          variants: [
            {
              className: "keyword",
